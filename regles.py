...
def nouvelle_regle():
    ...
    infection.pack()
    recuperation_min = Scale(fen, orient='horizontal', from_=0,to=9, resolution=1, tickinterval=1, length=350, label="Nombre minimum de jours pour être soigné")
    recuperation_min.pack()
    recuperation_max = Scale(fen, orient='horizontal', from_=0,to=9, resolution=1, tickinterval=1, length=350, label="Nombre maximum de jours pour être soigné")
